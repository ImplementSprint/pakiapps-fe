...
const theme: ProfileTheme = {
  fieldLabel: 'text-[#39B5A8]',
  inputEnabled: 'bg-white border-[#39B5A8]/30 focus:border-[#39B5A8] text-[#1A5D56]',
  inputDisabled: 'bg-[#F0F9F8] border-transparent text-[#1A5D56]/60',
  inputHeight: '',
  iconFocus: '',
  pwLabel: 'text-[10px] font-bold text-[#39B5A8] uppercase tracking-[0.2em] ml-1',
  pwInput: 'rounded-2xl pr-12 h-14 bg-[#F0F9F8] border-transparent focus:border-[#39B5A8]/30 font-bold pl-4 text-[#1A5D56]',
  pwToggleHover: 'hover:text-[#39B5A8]',
  modalBorder: 'border-[#39B5A8]/20',
  modalTitle: 'text-[#041614]',
  modalSubtitle: 'text-[#1A5D56]/60',
  reqBox: 'bg-[#F0F9F8] border-[#39B5A8]/10',
  reqLabel: 'text-[#39B5A8]',
  confirmEnabled: 'bg-[#39B5A8] hover:bg-[#2D8F85] text-white shadow-[#39B5A8]/20',
};
  ...
  return (
    <div className="flex h-screen bg-[#F0F9F8] font-sans text-[#1A5D56] overflow-hidden">
      ...
      <PasswordResetModal
        ...
        subtitle="Change your administrative system password."
              ...
              <div className="w-full lg:w-2/3">
                <form onSubmit={handleSave} className="bg-white rounded-[2.5rem] p-8 md:p-10 border border-[#39B5A8]/10 shadow-sm flex flex-col mb-4">
                  ...
                  <div className="grid md:grid-cols-2 gap-6">
                    ...
                    <div className="md:col-span-2">
                      <FormInput icon={<MapPin />} label="Address" value={formData.address} onChange={(v: string) => setFormData({ ...formData, address: v })} disabled={!isEditing} theme={theme} />
                    </div>
